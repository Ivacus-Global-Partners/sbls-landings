...
const CardsClaustroBecaAon = ({ claustro, title }: { claustro: { name: string, img: string, job: any }[], title: string }) => {
        ...
        <div className={classes.cardContainer}>
            <Container>
                <h1 className={classes.title}>
                    <img src="https://firebasestorage.googleapis.com/v0/b/sagardoy-lms.appspot.com/o/website%2Flandings%2FLanding%20Beca%20Aon%2FGrupo%2033%402x.png?alt=media&token=cd93e598-78c7-4afd-8f78-f305464aff92"
...
export default CardsClaustroBecaAon;